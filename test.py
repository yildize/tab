...
qa_constructor = MistralQAConstructorAdvanced(proxy_llm_url="http://31ec-34-91-219-175.ngrok-free.app/ask", source_docs_path="./storage/sources/uni-alt",
                                              ready_docs_path="./storage/docs/ready_docs.pkl", derived_questions_path="./storage/extracted_questions/qs.json")
